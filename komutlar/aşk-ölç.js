...
let moon2 = moon[Math.floor(Math.random() * moon.length)]
let proreiz = msg.mentions.members.first()
     if (!proreiz) return msg.channel.send(':heart: Kimi Sevdiğini Etiketle?') 
  msg.channel.send(`${msg.author}, ${proreiz} İle Olan Aşkını ${moon2}.`)
    }
